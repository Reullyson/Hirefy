                    ...
                    <div style={{ background: '#F8FAFC', padding: '2rem', borderRadius: '1rem', border: '1px solid #e2e8f0' }}>
                        ...
                        <form onSubmit={handleLogin}>
                            ...
                            <div style={{ marginBottom: '1rem' }}>
                                ...
                                <div style={{ position: 'relative' }}>
                                    <input 
                                        ...
                                        style={{ width: '100%', padding: '0.75rem', paddingRight: '2.5rem', border: '1px solid #e2e8f0', borderRadius: '0.5rem', fontSize: '0.875rem', background: '#F8FAFC', color: '#0F172A' }} 
                                        required 
                                    />
                                    <button 
                                        type="button" 
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: '1rem 0 1.5rem', fontSize: '0.875rem' }}>
                                ...
                                <button 
                                    type="button" 
                                    onClick={() => setAlert({ message: 'Recuperação de senha em desenvolvimento!', type: 'info' })} 
                        ...
                        {/* Botão Google movido para depois do botão Entrar */}
                        ...
                        <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: '#64748b' }}>
                            Ainda não tem uma conta? <Link href="/cadastro" style={{ color: '#059669', textDecoration: 'none', fontWeight: 700 }}>Cadastre-se</Link>
                        </div>
                    </div>
                </div>
            </div>
